...
const selectedLinesUrl = 'https://gist.github.com/pastorsj/dcb242de864e5d2b1c552783a7a00794#file-test-js-L10-L16';
const gistId = 'dcb242de864e5d2b1c552783a7a00794';
...
describe('Gist Snapshot Testing', () => {
    ...
    describe('Gist: Standard Conversion using GistId', () => {
        const file = 'gist_standard_id.png';
        before((done) => {
            retrieveScreenshot(done, gistId, HTML_FILE);
        });
        it('should return html that is formatted correctly', (done) => {
            const driver = new webdriver.Builder()
                .withCapabilities(webdriver.Capabilities.chrome())
    ...
    describe('Gist: Selected Lines', () => {
        const file = 'gist_selected_lines.png';
        before((done) => {
